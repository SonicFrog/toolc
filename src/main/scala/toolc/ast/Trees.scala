...
object Trees {
  ...
  case class ClassDecl(id: Identifier, parent: Option[Identifier], vars: List[VarDecl], methods: List[MethodDecl], constructor : MethodDecl) extends Tree with Symbolic[ClassSymbol]
